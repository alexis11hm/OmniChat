...
import 'package:chat_real_time_app/ui/home/chat/selection/group_selection_view.dart';
...
class FriendsSelectionView extends StatelessWidget {
  void _createFriendChannel(
    ...
    final channel = await context
        ...
        .createFriendsChannel(chatUserState);
    pushAndReplaceToPage(context,
        Scaffold(body: StreamChannel(channel: channel, child: ChannelPage())));
  }
